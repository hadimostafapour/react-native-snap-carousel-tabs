...
export default class Carousel extends Component {
  ...
  static propTypes = {
    ...
    underlineStyle: ViewPropTypes ? ViewPropTypes.style : View.propTypes.style,
  ...
  get tabs() {
    ...
    return (
      <Tabs
        ...
        scrollValue={this._scrollPos}
        snapToItem={this.snapToItem.bind(this)}
        activeTabIndex={activeSlide}
  ...
  render() {
    ...
    const dataItems = this._needsRTLAdaptations() ? [...props.data].reverse() : props.data;

    return <View style={{flex: 1}}>
      {this.props.renderTabs ? this.tabs : null}
      {this._needsScrollView() ? (
        ...
        <AnimatedFlatList {...props} data={dataItems}/>
      )}
    </View>;
  }
}
